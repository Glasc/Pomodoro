  ...
  <div class="flex justify-center px-3">
    <ul class="menu menu-vertical sm:menu-horizontal rounded-box w-full max-w-xl">
      <li  class="flex-1 cursor-pointer">
        <button tabindex="0" class="block rounded-none text-base text-center w-full px-6 py-4 disabled:bg-base-100 font-medium " :class="{
      ...
      <li  class="flex-1 cursor-pointer rounded-xl">
        <button tabindex="0" class="block rounded-none text-center text-base px-6 py-4 disabled:bg-base-100 font-medium " :class="{
      ...
      <li  class="flex-1 cursor-pointer ">
        <button tabindex="0" class="block rounded-none w-full text-center text-base bg-base-300 px-6 py-4 disabled:bg-base-100 font-medium " :class="{
