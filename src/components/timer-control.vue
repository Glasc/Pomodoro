<template>
  <button data-start-button v-if="!isRunning" class="btn btn-lg block mx-auto" :class="buttonClass" @click="start">
    Start
  </button>
  <button data-stop-button v-else class="btn btn-error btn-lg block mx-auto mt-8" @click="stop">
    Stop
  </button>
</template>
